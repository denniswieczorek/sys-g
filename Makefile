OBJ = main.o Controller.o View.o Xn.o Monomial.o Polynomial.o Ideal.o Grobner.o
...
Monomial.o: Monomial.cc Monomial.h LinkedList.h Xn.h
	g++ -c Monomial.cc
...
Grobner.o: Grobner.cc Grobner.h Ideal.h
	g++ -c Grobner.cc
clean:
	rm -f $(OBJ) test
